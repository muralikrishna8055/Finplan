                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="add_blog.html" class="dropdown-item">ADD BLOG</a>
                            <a href="view_blogs.html" class="dropdown-item">VIEW BLOGS</a>
                            <a href="manage_blogs.html" class="dropdown-item">MANAGE BLOGS</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="view_advisors.html" class="dropdown-item">VIEW ADVISORS</a>
                        </div>
                    </div>
                    <a href="view_feedback.html" class="nav-item nav-link"><i class="fas fa-comments me-2"></i>FEEDBACK</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
