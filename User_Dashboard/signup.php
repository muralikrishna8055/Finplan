...
if(isset($_POST['submit'])) {
    ...
    if($count == 1) {  
        ...
        $query = "INSERT INTO reg (id, name, email, password,type) VALUES (0, '$name', '$email', '$hashed_pass','$type')";
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                     ...
                     <!--   <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <button type="submit" value="submit" name="submit" class="btn btn-primary py-3 w-100 mb-4">Sign Up</button>
